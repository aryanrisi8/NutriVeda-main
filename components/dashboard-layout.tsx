      ...
      <header className="h-16 border-b border-border bg-surface px-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-serif font-bold text-primary">NutriVeda</h1>
          </div>
          <div className="h-6 w-px bg-border ml-4" />
          <span className="text-sm text-muted-foreground">Transform traditional knowledge into personalized care</span>
        </div>
